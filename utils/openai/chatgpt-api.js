...
var ChatGPTAPI = /** @class */ (function () {
                                ...
                                switch (_c.label) {
                                                ...
                                                try {
                                                    ...
                                                    if ((_a = response.choices) === null || _a === void 0 ? void 0 : _a.length) {
                                                        ...
                                                        if (delta.function_call) {
                                                            ...
                                                            result.toolCalls = [{
                                                                    id: ((_a = result.toolCalls) === null || _a === void 0 ? void 0 : _a[0].id) || result.functionCall.name,
                                                                    type: 'function',
                                                            ...
                                                            result.toolCalls = [{
                                                                    id: toolCall.id || ((_a = result.toolCalls) === null || _a === void 0 ? void 0 : _a[0].id) || result.functionCall.name,
                                                            ...
                                                            if (delta === null || delta === void 0 ? void 0 : delta.reasoning_content) {
                                                                ...
                                                                result.raw_thinking_text = (result.raw_thinking_text || '') + delta.reasoning_content;
                                                            }
                                                        }
                                                        if (delta.role) {
                                    ...
                                    case 5:
                                        ...
                                        if ((_a = response === null || response === void 0 ? void 0 : response.choices) === null || _a === void 0 ? void 0 : _a.length) {
                                            ...
                                            if (message_1.function_call) {
                                                result.functionCall = message_1.function_call;
                                                result.toolCalls = [{
                                                        id: message_1.function_call.name,
                                                        type: 'function',
                                            ...
                                            result.raw_thinking_text = message_1.reasoning_content;
                                            if (message_1.role) {
    ...
    ChatGPTAPI.prototype._buildMessages = function (text, role, opts, completionParams) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, systemMessage, parentMessageId, userLabel, assistantLabel, maxNumTokens, messages, systemMessageOffset, normalizeMessageForChatCompletion, sanitizeToolMessages, nextMessages, functionToken, numTokens, prompt_1, nextNumTokensEstimate, _i, _b, m1, _c, isValidPrompt, parentMessage, parentMessageRole, maxTokens;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        normalizeMessageForChatCompletion = function (message) {
                            if (message.role === 'function') {
                                return {
                                    role: 'tool',
                                    tool_call_id: message.tool_call_id || message.toolCallId || message.name,
                            ...
                            if (message.function_call) {
                                return {
                                    ...
                                    tool_calls: message.tool_calls || [{
                                            id: message.tool_call_id || message.toolCallId || message.function_call.name,
                                            type: 'function',
                        ...
                        sanitizeToolMessages = function (inputMessages) {
                            var sanitized = [];
                            var pendingToolCallIds = new Set();
                            var requiresReasoningForToolCalls = Boolean(completionParams === null || completionParams === void 0 ? void 0 : completionParams.thinking);
                            var _loop_1 = function (i) {
                                ...
                                if (message.role === 'assistant' && ((_a = message.tool_calls) === null || _a === void 0 ? void 0 : _a.length)) {
                                    var requiredToolCallIds = message.tool_calls.map(function (toolCall) { return toolCall === null || toolCall === void 0 ? void 0 : toolCall.id; }).filter(Boolean);
                                    var followingToolCallIds = [];
                                    for (var j = i + 1; j < inputMessages.length && (inputMessages[j] === null || inputMessages[j] === void 0 ? void 0 : inputMessages[j].role) === 'tool'; j++) {
                                        followingToolCallIds.push(inputMessages[j].tool_call_id);
                                    }
                                    var hasAllToolResults = (!requiresReasoningForToolCalls || Boolean(message.reasoning_content)) &&
                                        requiredToolCallIds.length > 0 &&
                                        requiredToolCallIds.every(function (id) { return followingToolCallIds.includes(id); });
                                    if (!hasAllToolResults) {
                                        var withoutToolCalls = __assign({}, message);
                                        delete withoutToolCalls.tool_calls;
                                        sanitized.push(__assign(__assign({}, withoutToolCalls), { content: message.content || '' }));
                                        return "continue";
                                    }
                                    requiredToolCallIds.forEach(function (id) { return pendingToolCallIds.add(id); });
                                }
                                sanitized.push(message);
                            };
                        ...
                        nextMessages = text
                            ? messages.concat([
                                normalizeMessageForChatCompletion({
                                    role: role,
                                    content: text,
                                    name: opts.name,
                    ...
                    case 7:
                        ...
                        nextMessages = nextMessages.slice(0, systemMessageOffset).concat(__spreadArray([
                            normalizeMessageForChatCompletion({
                                ...
                                reasoning_content: parentMessage.raw_thinking_text || parentMessage.reasoning_content ||
                                    (((_a = parentMessage.thinking_text) === null || _a === void 0 ? void 0 : _a.includes('【工具调用')) ? undefined : parentMessage.thinking_text),
                    ...
                    case 9:
                        ...
                        if ((completionParams === null || completionParams === void 0 ? void 0 : completionParams.functions) && !(completionParams === null || completionParams === void 0 ? void 0 : completionParams.tools)) {
                            completionParams.tools = completionParams.functions.map(function (func) { return ({
                                type: 'function',
                                function: func
                            }); });
