...
import { isMasterQQ, isQQInList } from './ToolUtils.js'
...
export class EditCardTool extends AbstractTool {
  ...
  func = async function (opts, e) {
    ...
    try {
      ...
      if (qq === e.bot.uin || (!isMaster && isQQInList(masters, qq))) {
        return 'failed, you cannot edit card of bot or master'
      }
      if (!isMaster && ['owner', 'admin'].includes(mm.get(qq).role) && sender != qq) {
        return 'failed, you cannot edit card of group owner or administrator'
      }
