...
export function publicModelImageUrl (value: unknown): string {
...
export type ModelMessage =
  | Readonly<{ role: 'system' | 'developer'; content: string }>
  | Readonly<{ role: 'user'; content: string; imageUrls?: readonly string[] }>
  | Readonly<{
      role: 'assistant'
      content: string | null
