...
type ProviderSurfaceEntries = Readonly<Record<ProviderSurfaceId, readonly string[]>>

interface ProviderSurfaceManifest {
  sources: ProviderSurfaceEntries
  commands: ProviderSurfaceEntries
  configFields: ProviderSurfaceEntries
  uiFields: ProviderSurfaceEntries
  dependencies: ProviderSurfaceEntries
  lexicalMarkers: ProviderSurfaceEntries
  preservedExclusions: {
...
} as const satisfies ProviderSurfaceManifest
