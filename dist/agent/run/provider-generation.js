...
import { parseProviderRequestMetadata } from '../model/model-adapter.js';
...
function parseFields(value, includeSchemaVersion) {
...
export function createFrozenProviderGenerationV1(value) {
    return parseFields(value, false);
}
export function parseFrozenProviderGenerationV1(value) {
    return parseFields(value, true);
}
export function providerRequestScopeFingerprint(metadata) {
...
export function providerRequestWireIdentity(value) {
    let encoded;
    try {
