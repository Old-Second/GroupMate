...
export const ADAPTIVE_CONTEXT_LOOP_POLICY = Object.freeze({
    schemaVersion: 1,
    kind: 'adaptive_context'
});
export function parseRunModelLoopPolicyV1(value) {
...
export function legacyFixedLoopPolicy(maxEstimatedTokens) {
