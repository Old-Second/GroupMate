...
export function calculateModelCost(snapshot, usage) {
    ...
    const picoYuan = roundHalfUp(BigInt(hitTokens) * BigInt(snapshot.inputCacheHitPicoYuanPerMillionTokens) +
