...
function canonicalStringWithinLimits(value, maximumUtf8Bytes, maximumCodePoints) {
...
export function memoryTextWithinLimits(value) {
    return canonicalStringWithinLimits(value, MEMORY_RESOURCE_LIMITS.textUtf8Bytes, MEMORY_RESOURCE_LIMITS.textCodePoints);
}
export function memorySourceExcerptWithinLimits(value) {
    return canonicalStringWithinLimits(value, MEMORY_RESOURCE_LIMITS.sourceExcerptUtf8Bytes, null);
}
export function memoryCanonicalTextWithinLimits(value, maximumUtf8Bytes, maximumCodePoints) {
