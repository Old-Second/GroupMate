    ...
    configInfo: {
      ...
      schemas: [
        ...
        },
        {
          ...
          label: '允许智能模式跨群发送',
          bottomHelpMessage: '是否允许智能模式下向非当前会话发送消息、图片、骰子、音乐或视频。主人不受影响，默认关闭。',
          component: 'Switch'
        },
        {
          field: 'enableToolVideoDownload',
          label: '允许智能模式下载并发送视频',
          bottomHelpMessage: '关闭时B站视频工具只发送视频信息和链接，避免下载大文件。',
          component: 'Switch'
        },
        {
          field: 'toolVideoMaxMB',
          label: '智能模式视频下载大小上限(MB)',
        ...
        },
        {
          ...
          label: 'API思考模式',
          bottomHelpMessage: 'DeepSeek等兼容API的思考模式开关。默认表示不显式传参，使用模型服务默认行为。',
          component: 'Select',
          componentProps: {
            options: [
        ...
        },
        {
          ...
          label: 'API思考强度',
          bottomHelpMessage: 'DeepSeek思考模式强度。默认表示不显式传参，普通请求由服务端使用默认强度。',
          component: 'Select',
          componentProps: {
            options: [
              { label: '默认', value: 'default' },
        ...
        {
          field: 'bymThinkingMode',
          label: '伪人API思考模式',
          bottomHelpMessage: '仅伪人模型选择OpenAI API时生效。默认表示不显式传参，使用模型服务默认行为。',
          component: 'Select',
          componentProps: {
            options: [
              { label: '默认', value: 'default' },
        ...
        {
          field: 'bymReasoningEffort',
          label: '伪人API思考强度',
          bottomHelpMessage: '仅伪人模型选择OpenAI API时生效。默认表示不显式传参。',
          component: 'Select',
          componentProps: {
            options: [
              { label: '默认', value: 'default' },
        ...
        {
          field: 'bymFuckBlacklist',
          label: '伪人模式骂人黑名单',
          bottomHelpMessage: '在此名单中的QQ号不会触发骂人反击，但会正常触发伪人模式回复',
          component: 'GTags',
          componentProps: {
            placeholder: '请输入QQ号',
            allowAdd: true,
        ...
        },
        {
          ...
          bottomHelpMessage: 'https://app.tavily.com/home',
          component: 'InputPassword'
        },
        {
          field: 'braveSearchApiKey',
          label: 'Brave Search API Key',
          bottomHelpMessage: 'https://api-dashboard.search.brave.com/app/keys',
          component: 'InputPassword'
        },
        {
          field: 'serpSource',
          label: '搜索来源，Tavily/Azure需填写对应key，ikechan8370为作者自备源',
          component: 'Select',
          componentProps: {
            options: [
        ...
        },
        {
          ...
          label: '图片搜索来源',
          bottomHelpMessage: 'auto优先Tavily，失败后使用Brave；ikechan8370仅作为兼容旧公益接口。',
          component: 'Select',
          componentProps: {
            options: [
              { label: '自动', value: 'auto' },
